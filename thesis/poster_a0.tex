...
\vspace{0.2cm}
\centering
\includegraphics[width=0.98\linewidth]{../figures/correlation_map.png}
\vspace{0.1cm}
...
\vspace{0.2cm}
\centering
\includegraphics[width=0.99\linewidth]{../figures/finding.png}
\vspace{0.1cm}
...
\vspace{0.2cm}
\centering
\includegraphics[width=0.86\linewidth]{../figures/tail_dependence_taskc.png}
}
...
\vspace{0.2cm}
\centering
\includegraphics[width=0.99\linewidth]{../figures/copula_density.png}\\[0.3cm]
\includegraphics[width=0.99\linewidth]{../figures/copula_result.png}
\vspace{0.1cm}
...
\end{itemize}
\vspace{0.2cm}
\small Reproducible pipeline: \textbf{202 tests}, pre-committed configs,
