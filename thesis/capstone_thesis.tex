...
solver-path artifacts rather than exploitable structure. The two earlier panels
agree: California/Nevada gaps lie in $[-0.012,+0.058]\%$ and Iberia--France in
$[-0.016,+0.321]\%$, with the single $0.32\%$ cell not sign-stable across
residual estimators. Cross-validation selects $\varepsilon^\star=1$ in 26 of 27
cells, so both arms are genuinely robustified --- the null is not an artifact of
the DRO being switched off.
