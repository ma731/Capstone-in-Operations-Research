...
empirical null across the dependence spectrum}: five region sets --- three
interconnected sets where strong correlation survives de-seasonalization
(California/Nevada; US West; Ontario--Eastern belt), one European set where
residual correlation collapses to the diurnal cycle (Iberia--France), and one
engineered near-uncorrelated solar/wind/hydro portfolio --- all yield spatial gaps
below $0.4\%$ of $\CVaR$,
