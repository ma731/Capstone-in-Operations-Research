...
independence baseline by a material, sign-stable margin: the largest absolute
copula gap anywhere is $0.13\%$ of $\CVaR_{0.95}$ (\texttt{us\_hetero}), with signs
flipping across $\alpha$ exactly as in Phase 1. The null is now \emph{total} --- it
holds not just for the covariance ball but for the full copula.
