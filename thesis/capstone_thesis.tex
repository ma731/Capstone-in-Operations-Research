...
that is Phase 2. \emph{(iv)~Geographic scope.} The region sets span WECC, the
...
spatial covariance improves carbon-aware DRO scheduling, across multiple real grids;
