...
DRO solved as a second-order cone program, we design a falsification test --- the
schedule fitted to the joint covariance versus one fitted to a block-diagonal
covariance with cross-region structure destroyed --- evaluated by out-of-sample
conditional value-at-risk ($\CVaR_{0.95}$) of daily emissions under
...
leaves that same already-rejected cell as the largest surviving positive gap ---
nothing material survives both filters.
