...
This appendix sketches where the line goes next, with \emph{preliminary,
proof-of-concept} experiments. They are prototype-grade --- a stylised
grid-emergency stress model, modest scenario counts, no pre-registration --- and a
rigorous treatment is the subject of a follow-on study; we include them only because
