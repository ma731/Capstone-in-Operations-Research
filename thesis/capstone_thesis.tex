...
% RUN 3: answers to RQ1-3; contributions recap; future work (vine-copula ambiguity
% sets; inter-region transfer channel; rolling re-optimization)
\emph{[Completed in Run 3.]}
...
% RUN 3: repo pointers, scripts, result-snapshot mapping, full gap tables
\emph{[Completed in Run 3.]}
\section{Annex A: Individual Contribution Statement}\label{app:ics}
% RUN 3: Marco's ICS (role summary; per-section contributions; defense focus areas;
