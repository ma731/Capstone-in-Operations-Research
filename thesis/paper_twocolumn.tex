...
emergencies across 17 zones never reach; the robust DRO-plus-active-transfer artifact behind this rule is characterised but preliminary (Appendix~\ref{app:phase3}), so the contribution is the decision rule and its data-grounded crossover rather than a production controller. (iv)~\emph{A reproducible pipeline}:
