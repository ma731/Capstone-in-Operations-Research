...
tested, data-grounded bound, all under 202 unit tests, with the Phase~1--2 falsification protocol pre-committed (the stylised-emergency crossover of RQ3 is a calibrated stress test, not part of the pre-commitment).
    \end{abstract}
    \vspace{1.4em}
  \end{@twocolumnfalse}
]
...
\begin{figure}[t]
\centering
\includegraphics[width=0.92\columnwidth]{../figures/transfer_value_curve.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.85\columnwidth]{../figures/complexity_frontier.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.72\columnwidth]{../figures/tail_dependence_taskc.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.8\columnwidth]{../figures/crossover.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\columnwidth]{../figures/scenario_convergence.pdf}
