...
validated pipeline}: pre-commitment, $199$ unit tests, a small-instance model
...
suite, $199$ unit tests total ($186$ run in CI; the 13 Electricity Maps integration tests need licensed data and are excluded from CI), including a feasible-set equivalence test pinning the
...
version-controlled repository with a continuous-integration suite ($186$ unit
tests run in CI of $199$ total; the 13 Electricity Maps integration tests are excluded from CI as they require
