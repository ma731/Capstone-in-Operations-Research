...
recovers nothing. A dimensionless condition $\Delta$ generalises the screen beyond
carbon, reported as a coarse ordinal indicator (it does not bind on the real grids, so
the empirical falsification remains necessary there). (iv)~\emph{A price-of-robustness
