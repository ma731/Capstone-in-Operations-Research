...
| **Literature review** | **Keep (light recast)** | Add the "how much modeling is worth it" gap; **cite Yaxin's deterministic transfer explicitly** (attribution). Drop the "spatial DRO is untested" framing. |
