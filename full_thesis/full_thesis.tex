...
by $4.7$--$10.1\%$, and a two-stage robust commitment exposes a tail-risk
...
$4.7$--$10.1\%$ of $\CVaR_{0.95}$ and exhibits a tail-risk crossover on the correlated grid under
...
$[-18.3,-4.4]$): with the mean already capturing the placement value (the grid's
...
\emph{active} transfer decision unlocks $4.7$--$10.1\%$, and under \emph{severe}
