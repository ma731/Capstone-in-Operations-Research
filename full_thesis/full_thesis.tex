...
the deterministic one on the US West ($+0.3\%$, 95\% CI $[-0.6,+1.2]$) and Eastern
($+0.0\%$, $[-0.1,+0.3]$) grids, but is significantly \emph{worse} on the Diversified
grid ($-10.3\%$, $[-18.3,-4.4]$): hedging forecast error when no emergency is present
...
inter-region transfer in a pre-registered study. Further
...
\texttt{part4\_online\_2026-06-15.csv}\\
\bottomrule
\end{tabular}
\end{table}
