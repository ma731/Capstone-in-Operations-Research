...
reproducible, validated pipeline} (Section~\ref{sec:testing}): pre-registration, $194$
...
\paragraph{The mean-leveling test (RQ3, mechanism).} To test whether the mean field masks the
