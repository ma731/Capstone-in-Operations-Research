...
pre-registered protocol, and a $187$-test software suite.
\end{abstract}
\newpage
\tableofcontents
\newpage
...
small-instance model validation, a pre-registered protocol, and a $187$-test software
...
suite, $187$ unit tests, including a feasible-set equivalence test pinning the
...
The implementation carries a $187$-test suite run under continuous integration on
...
flattening operators against hand-computed cases, bringing the suite to $187$ tests.
...
version-controlled, CI-tested pipeline (187 tests) with archived license-safe
...
version-controlled repository with a continuous-integration suite ($187$ unit
