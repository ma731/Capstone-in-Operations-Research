...
bound, all under 202 unit tests, with the Phase~1--2 falsification protocol pre-committed (the stylised-emergency crossover of RQ3 is a calibrated stress test, not part of the pre-commitment).
\end{abstract}
\newpage
\tableofcontents
\newpage
