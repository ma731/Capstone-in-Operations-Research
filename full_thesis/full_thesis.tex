...
pre-registered protocol, and a $202$-test software suite. The thesis contributes a
...
bound, all under 202 unit tests, with the Phase~1--2 falsification protocol pre-registered (the stylised-emergency crossover of RQ3 is a calibrated stress test, not part of the pre-registration).
\end{abstract}
\newpage
\tableofcontents
\newpage
...
(ii)~\emph{A pre-registered methodology for pricing modelling layers}: holding the
...
reproducible, validated pipeline} (Section~\ref{sec:testing}): pre-registration, $202$
...
pre-registered, triangulated \emph{measurement} of the dependence layer's value, not
...
(Figure~\ref{fig:part5}), and the pre-registered mean-leveling test confirms the empirical
...
pre-registered mean-leveling test (a different, tighter feasible set); what transfers is the
